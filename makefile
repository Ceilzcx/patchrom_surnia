...
local-out-zip-file := MIUI_Surnia.zip
...
# All apks from MIUI
local-miui-removed-apps := FM SogouInput Mipay MiuiVideo GameCenter XiaomiVip MiGameCenterSDKService
